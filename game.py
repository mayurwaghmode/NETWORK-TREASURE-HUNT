    ...
    return render_template(
     ...
     #   event=EVENT_DATA['name'],
       ...
       # social=EVENT_DATA['social'], discuss=EVENT_DATA['discuss'],
        intro=EVENT_DATA['intro'], year=YEAR,
...
def register():
    ...
    if request.method == 'POST':
        try:
            ...
            return render_template(
                'register.html', event="NETWORK TREASURE HUNT",
        social="https://www.instagram.com/acespvg/?hl=en",
        host="ACESPVG" ,discuss=EVENT_DATA['discuss'],
...
def login():
    ...
    if request.method == "POST":
        try:
            ...
            return render_template(
                'login.html',event="NETWORK TREASURE HUNT",
        social="https://www.instagram.com/acespvg/?hl=en",
        host="ACESPVG",error=True, reason=reason, year=YEAR, next=redir
            )
    else:
        return render_template(
            'login.html',event="NETWORK TREASURE HUNT",
...
def level(path):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'level.html',
            year=YEAR, event="NETWORK TREASURE HUNT",
        social="https://www.instagram.com/acespvg/?hl=en",
        host="ACESPVG", discuss=EVENT_DATA['discuss'],
...
if __name__ == '__main__':
    app.run(host='127.0.0.1', debug=ENV_DEV, threaded=False)
